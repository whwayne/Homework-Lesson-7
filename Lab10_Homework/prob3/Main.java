...
public class Main {
    ...
    public static <T> boolean contains3(List<? extends T> list, T t,
                                                         BiPredicate<T, ? super T> pred3) {
        for(T t1: list) {
            if(t1 == null && t == null) return true;
            if(t1 == null || t == null) continue;
            if(pred3.test(t1, t)) return true;
        }
        return false;
    }
    ...
    public static void test5() {
		...
		boolean foundIt = Main.contains3(list, a,
